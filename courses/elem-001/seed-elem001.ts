...
async function seed() {
  const mdPath = path.resolve(__dirname, 'ELEM001-elementary-program-crash-course.md');
  ...
  // Map this crash course to the Elementary track when the admin track exists.
  ...
  if (elementaryTrack) {
    ...
    console.log('ℹ️  Elementary track not found; skipping course_programs mapping.');
  }
